...
namespace BLW.Lib.FileTransfer
{
    public partial class SftpManager 
    {
        ...
        public SFTPFileTransferAdapter objFileDownloadingFromSftp { get; set; }
        public IAdaperSettings objAdpterSettings { get; set; }
        ...
        public void SftpDeleteFile(String sftpFile)
        {
            ...
            catch (Exception ex)
            {
                 ...
                 throw new DeleteFileExp("Error while deleting file from SFTP. Error: " + ex); ;
            }
        ...
        public void SftpFileUpload(String localFile, string remortLocation)
        {
            ...
            {
                throw new FileUploadExp("Error while uploading file"+ localFile +" on SFTP."+ ex.Message);
            }
        }
